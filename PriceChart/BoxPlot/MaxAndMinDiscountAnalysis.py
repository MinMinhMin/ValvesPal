...
class MaximumMinimumDiscountBoxPlot:
        ...
        for shop in self.shops_data:
            ...
            if len(discounts) > 1:  # Đảm bảo có đủ dữ liệu
                ...
                try:
                    ...
                    forecast = [
                        round(max(0, val), 2) for val in forecast
        ...
        chart_config = {
            ...
            "series": [
                ...
                },
                {
                    ...
                    "tooltip": {
                        "pointFormat": "Trung bình lý thuyết: {point.y:.2f}%<br/>"
                    },
                },
            ],
        }
    ...
    def generate_js(self, output_file="price_chart_boxplot.js"):
        """
        ...
        script_content = textwrap.dedent(
            """document.addEventListener('DOMContentLoaded', function () {{
                ...
                original_chart_json, predicted_chart_json
            )
        )
        ...
        print(f"Chart Scripts has been saved to {output_file}")


def main():
    # Các thông tin cần thiết
    api_key = "07b0e806aacf15f38b230a850b424b2542dd71af"
    game_id = "018d937f-6ee4-73f5-858c-2fde3407462f"
    ...
    box_plot_chart.generate_js(
        "PriceChart/BoxPlot/price_chart_boxplot.js"
    )  # Tạo file js cho biểu đồ Box Plot
